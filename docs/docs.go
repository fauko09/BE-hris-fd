    ...
    "paths": {
        ...
        "/cuti": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Cuti Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CutiRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.ApproveCutiRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/divisi": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Divisi Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.DivisiRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/employees/{uid}/data": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Data User Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.DataUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/employees/{uid}/photo": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "File foto (jpg/jpeg/png, max 2MB)",
                        "name": "photo",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/jabatan": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Jabatan Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.JabatanRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/penggajian": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter periode (contoh: 2026-05)",
                        "name": "periode",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Penggajian Request",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.PenggajianRequest"
                        }
                    }
                ],
                "responses": {
